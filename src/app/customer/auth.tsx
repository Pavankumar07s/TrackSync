   ...
   <SafeAreaView style={authStyles.container}>
    <ScrollView contentContainerStyle={authStyles.container}>
        <View style={commonStyles.flexRowBetween}>
            <Image source={require('@/assets/images/logo_t.png')} style={authStyles.logo}></Image>
            <TouchableOpacity style={authStyles.flexRowGap}>
                <MaterialIcons name="help" size={18} color='grey'></MaterialIcons>
                <CustomText fontFamily='Medium' varient='h5'>Help</CustomText>
            </TouchableOpacity>
        </View>
        <CustomText fontFamily='Medium' style={commonStyles.lightText}>What's your number?</CustomText>
